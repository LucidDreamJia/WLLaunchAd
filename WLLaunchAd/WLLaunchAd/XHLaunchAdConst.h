...
#define XH_SAFETY_AREA_INSETS [UIApplication sharedApplication].keyWindow.safeAreaInsets
#define XH_STATUSBAR_HEIFHT [UIApplication sharedApplication].statusBarFrame.size.height
